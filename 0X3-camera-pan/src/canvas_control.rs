...
impl Component for CanvasControl {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        ...
        wasm_bindgen_futures::spawn_local(async move {
            let filename = "assets/cube_tex_sq.gltf".to_string();
    ...
    fn update(&mut self, ctx: &Context<Self>, msg: Self::Message) -> bool{
        match msg {
            ...
            CanvasControlMsg::MouseMove(evt) => {
                ...
                let x = evt.0 as f32 / self.width as f32;
...
impl CanvasControl {
    ...
    fn canvas_update(&mut self) {
        ...
        self.camera.move_camera_x(self.rot.sin() * self.cam_dist);
        self.camera.move_camera_y(self.cam_height);
        self.camera.move_camera_z(self.rot.cos() * -self.cam_dist);
        self.camera.refresh();
